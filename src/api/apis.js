...
export const getPackages = async (params) => {
  try {
    const res = await axiosInstance.get("/packages/get-all-packages", { params });
    return res.data;
  } catch (error) {
    console.error(
...
export const getPackageById = async (id) => {
  try {
    const res = await axiosInstance.get(`/packages/get-package/${id}`);
    return res.data;
  } catch (error) {
...
export const deletePackage = async (id) => {
  try {
    const res = await axiosInstance.delete(`/packages/delete-package/${id}`);
    return res.data;
  } catch (error) {
